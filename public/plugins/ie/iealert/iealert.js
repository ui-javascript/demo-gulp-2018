	...
	function iealert(){
		var title = "您使用的浏览器版本过低",
			...
			panel = "<span style=\"font-size:18px;margin: 0 0 20px 0;display:block;padding:0;\">"+ title +"</span>"
			      ...
			      + "<li style='float:left;margin:0 22px 0 0;'><a href='https://www.google.com/chrome/' target='_blank' style='display:inline-block;background: url(iealertsprite.png) no-repeat;background-position: 0 0;width: 73px;height: 96px;margin:0 4px 0 0;'></a></li>"
			      + "<li style='float:left;margin:0 22px 0 0;'><a href='http://www.mozilla.org/en-US/firefox/new/' target='_blank' style='display:inline-block;background: url(iealertsprite.png) no-repeat;background-position: -292px 0;width: 73px;height: 98px;'></a></li>"
			      + "<li style='float:left;margin:0 22px 0 0;'><a href='http://windows.microsoft.com/en-US/internet-explorer/downloads/ie/' target='_blank' style='display:inline-block;background: url(iealertsprite.png) no-repeat;background-position: -179px 0;width: 95px;height: 98px;'></a></li>"
			      + "<li style='float:left;margin:0 22px 0 0;'><a href='http://www.apple.com/safari/download/' target='_blank' style='display:inline-block;background: url(iealertsprite.png) no-repeat;background-position: -387px 0;width: 73px;height: 98px;margin:0 4px 0 0;'></a></li>"
			      + "<li style='float:left;'><a href='http://www.opera.com/download/' target='_blank' style='display:inline-block;background: url(iealertsprite.png) no-repeat;background-position: -90px 0;width: 73px;height: 98px;'></a></li>"
			      + "<ul>"
			      + "</div>";
